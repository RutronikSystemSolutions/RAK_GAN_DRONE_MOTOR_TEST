...
#define ADC_CS_CURRENT_SENSITIVITY               (0.022f)                      /*[V/A], Applicable for active current sense type of measurement*/
...
#define MOTOR_CTRL_FASTLOOP_FREQ                   (100000.0f)                 /*[Hz] fast-loop frequency */
#define MOTOR_CTRL_FS0_FS1_RATIO                   (10U)                       /*[], Fast-loop to slow-loop frequency ratio*/
...
/*********Rate Limiters*********/
#define MOTOR_CTRL_SPEED_CMD_RATE                  (MOTOR_MAX_SPEED / 4.0f)     /*[RPM/sec], Speed command rate*/
...
/*******************************************************************************/
/*******Observer*******/
#define MOTOR_CTRL_OBS_SPEED_THRESH                (320.0f)      /*[RPM], Observer activation speed threshold*/
#define MOTOR_CTRL_OBS_MIN_LOCK_TIME               (1.0f)                       /*[sec], Observer minimum lock time*/
...
/*********SPEED Controller*********/
#define MOTOR_CTRL_SPEED_BW                        (40.0f)                       /*[Hz], Speed loop bandwidth*/
#define MOTOR_CTRL_SPEED_OL_CL_TR_COEFF            (45.0f)                     /*[%], Open-loop to closed-loop transition coefficient*/
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW                      (4000.0f)                      /*[Hz], Current loop bandwidth*/
#define MOTOR_CTRL_CURRENT_FF_COEFF                (10.0f)                        /*[%], Current loop feed-forward coefficient*/
#define MOTOR_CTRL_CURRENT_STARTUP_THRESH          (5.8f)                        /*[A], Current control startup threshold*/
...
/*********Voltage Controller*********/
#define MOTOR_CTRL_VOLT_STARTUP_THRESH             (MOTOR_NORM_SPEED*0.03f)      /*[RPM], startup threshold*/
#define MOTOR_CTRL_VOLT_VF_OFFSET                  (0.18f)  					 /*[V], V/F ramp voltage offset*/
#define MOTOR_CTRL_VOLT_VF_RATIO                   (0.0040f)                     /*[V/(Rad/secz], V/f ramp slope*/
...
/*********Six-Pulse Injection*********/
#define MOTOR_CTRL_SIX_PULSE_INJ_MAX_CURRENT       (20.0f)                        /*[A}, Maximum current during  six pulse injection*/
...
#define MOTOR_CTRL_HFI_MAX_CURRENT                 (1.5f)                       /*[A], Maximum excitation current d-axis*/
#endif
/*******************************************************************************/
/*******DC Supply*******/
...
#define MOTOR_CTRL_PROFILER_I_CMD_DC   (MOTOR_CURRENT_CONT * 0.1f)              /*[A}, Target DC current*/
...
/*******Mechanical Load*******/
#define MECH_INERTIA                              (3.0E-4f)                    /*[kg.m^2],  Inertia*/
#define MECH_VISCOUS                              (5.5E-4f)                    /*[kg.m^2/sec], Viscous Damping*/
#define MECH_FRICTION                             (1.5E-1f)                   /*[kg.m^2/sec^2], Friction*/
