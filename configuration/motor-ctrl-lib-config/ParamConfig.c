...
void PARAMS_InitManual(PARAMS_t* params_ptr)
{
    ...
    params_ptr->ctrl.curr.i_cmd_ol = (MOTOR_CURRENT_CONT * 0.20f); // [A]

	//params_ptr->autocal_disable.current_control = 1;
    //params_ptr->ctrl.curr.kp.q = 0.471f; // [V/A]
    //params_ptr->ctrl.curr.kp.d = 0.471f; // [V/A]
    //params_ptr->ctrl.curr.ki.q = 518.3f; // [V/A.(Ra/sec)]
    //params_ptr->ctrl.curr.ki.d = 518.3; // [V/A.(Ra/sec)]
